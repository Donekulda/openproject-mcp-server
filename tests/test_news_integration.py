...
async def test_news_tools_integration():
    ...
    try:
        ...
        if all_found:
            ...
            pytest.fail("Some news tools are missing")
        ...
        try:
            ...
            pytest.fail(f"Failed to import list_news: {e}")
        ...
        try:
            ...
            pytest.fail(f"Failed to import create_news: {e}")
        ...
        try:
            ...
            pytest.fail(f"Failed to import get_news: {e}")
        ...
        try:
            ...
            pytest.fail(f"Failed to import update_news: {e}")
        ...
        try:
            ...
            pytest.fail(f"Failed to import delete_news: {e}")
        ...
        try:
            ...
            pytest.fail(f"Formatting test failed: {e}")
